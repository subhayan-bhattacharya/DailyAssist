import { AmplifyClassV6, KeyValueStorageInterface } from '@aws-amplify/core';
 ...
 * @internal
 */
export declare const getMultipartUploadHandlers: (amplify: AmplifyClassV6, uploadDataInput: MultipartUploadDataInput, size: number) => {
